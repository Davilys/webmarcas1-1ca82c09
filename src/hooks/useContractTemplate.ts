...
export function replaceContractVariables(
  ...
  const getPaymentDetails = () => {
    ...
    if (data.plan === 'corporativo') {
      return `• Assinatura mensal recorrente: R$ 1.497,00/mês — cobrada automaticamente via cartão de crédito.\n• O valor será atualizado anualmente com base no salário mínimo vigente.`;
    }
